...
4. New Character: If you would like to contribute to this wiki by adding a new character, mention a issue and open the PR.

**Important:** Every PR must correspond to any of the given topic related PRs.
...
9. Yay! You made a contribution. Keep it up.
...
```bash
git remote add upstream https://github.com/RedEdge967/MK-Wiki.git
```
